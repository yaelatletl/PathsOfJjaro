...
# get rid of this file; camera animations should be called from Player, which should know its own state and handle its own transitions from one state to another
