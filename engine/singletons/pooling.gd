...
# TO DO: this is a premature optimization; get rid of it: allocating and freeing projectile instances is unlikely to be a critical bottleneck; if performance profiling shows it's a problem, optimize then
