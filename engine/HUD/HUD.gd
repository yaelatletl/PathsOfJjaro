...
# TO DO: move `hud` node out of Player and into its own HUD.tscn, 

# TO DO: move ammo readouts onto gun stocks; it should not require its own screen space (showing number of remaining mags in top-right is sufficient; user can check at a glance if a weapon's ammo is running low; for a full list of weapons and ammo currently carried, user can bring up inventory overlay)
...
# TO DO: get rid of all these exports!
...
@export var interact_board_path: NodePath = "VerticalSections/Top/InteractionBoard"
@export var message_board_path: NodePath = "VerticalSections/Mid/MessageBoard"
