...
const PICKABLE_DEFINITIONS := [ # for now, this array is ordered same as PickableType enum and M2 map data, so we can convert map JSONs to PickableItems
	...
	{"pickable": Enums.PickableType.MAGNUM_MAGAZINE,       "long_name": ".44 Magnum Magazine",   "short_name": "MG44", "max_count": 50, "count":  1},
	...
	{"pickable": Enums.PickableType.AR_MAGAZINE,           "long_name": "AR Magazine",           "short_name": "MA75", "max_count": 15, "count":  1},
	{"pickable": Enums.PickableType.AR_GRENADE_MAGAZINE,   "long_name": "AR Grenade Magazine",   "short_name": "GREN", "max_count":  3, "count":  1},
