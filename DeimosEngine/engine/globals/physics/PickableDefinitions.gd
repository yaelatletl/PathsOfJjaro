...
const PICKABLE_DEFINITIONS := [ # for now, this array is ordered same as PickableType enum and M2 map data, so we can convert map JSONs to PickableItems
	...
	{"pickable": Enums.PickableType.ASSAULT_RIFLE,         "long_name": "MA75C Assault Rifle",   "short_name": "MA75", "max_count": 15, "count":  1},
	{"pickable": Enums.PickableType.AR_MAGAZINE,           "long_name": "AR Magazine",           "short_name": "MA75", "max_count":  8, "count":  4},
	{"pickable": Enums.PickableType.AR_GRENADE_MAGAZINE,   "long_name": "AR Grenade Magazine",   "short_name": "GREN", "max_count":  1, "count":  2},
